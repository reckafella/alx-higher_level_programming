...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        Args:
            rect_1 (obj): an instance of Rectangle object
            rect_2 (obj): an instance of Rectangle object
        """
    ...
    def square(cls, size=0):
        """
        Return a new Rectangle instance with size == width == height

        Args:
            size (int): new length and height
        """
        if (type(size) != int):
            raise TypeError("height must be an integer")
        if (size < 0):
